...
/**
 * @name pvc.data.MetricLineDotChartTranslationOper
 * 
 ...
 */
def.type('pvc.data.MetricLineDotChartTranslationOper')
.add(/** @lends pvc.data.MetricLineDotChartTranslationOper# */{
