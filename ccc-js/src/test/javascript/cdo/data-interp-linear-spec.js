...
define([
    ...
    describe('Categorical linear interpolation', function() {
        ...
        it('should work over categories having a corresponding null value', function() {
            var dataSpec = [
                {
                    resultset: [
                        ["S1", "CA",   20],
        ...
        it('should ignore null, continuous categories', function() {
            ...
            // 150 should not affect the extent of the value dimension.
            expect(visibleData.dimensions("value").extent()).toEqual({
                min: jasmine.objectContaining({value: 20}),
                max: jasmine.objectContaining({value: 70})
            });
        });
    });
});
